...
export const WelcomeDialog: React.FC = () => {
            ...
            tourSteps.push(
                {
                    ...
                    content: "To get started, please select an FMU directory. Please do not use an FMU directory that is used in production, as this editor is still in development and may cause issues. You could for example use a local copy of the Drogon example repo for testing.",
                });
            return tourSteps;
        }
        ...
        if (activeFilePath === "") {
            tourSteps.push(
                ...
                },
                {
                    ...
                    content: "You do also see your user name here. This is the name all your changes will be saved under."
                },
                {
                    selector: "#inner-content-wrapper",
                    content: "You are currently looking at the editor environment. Here, you can make changes to files in your own copy of the currently selected FMU working directory.",
                },
                {
                    selector: "#explorer",
                    content: "On the left hand side, you see a file explorer where you can browse your copy of the FMU working directory."
                },
                {
                ...
                {
                    selector: "#explorer",
                    content: "You can open files for editing by clicking on them. When double-clicking on file, you open it permanently. Please open a valid file now."
                }
            );
            return tourSteps;
        }
        ...
        if (uncommitted) {
            tourSteps.push(
                ...
                },
                {
                    ...
                    action: (domNode: any) => {
                        animateMouseClick({
                            target: domNode, flyIn: true, onFinished: () => {
                                window.setTimeout(() => {
                ...
                {
                    selector: "#inner-content-wrapper",
                    content: "The source control feature gives you an overview of all changes that were made in your selected model version. You can see who made the changes, when they were made and what was changed.",
                    action: () => {
                        dispatch(setChangesBrowserView(ChangesBrowserView.LoggedChanges));
                        dispatch(setCurrentCommit(undefined));
                    },
                },
                {
                    ...
                    content: "You can see all uncommitted changes that you have made by clicking on the current changes button.",
                    action: (domNode: any) => {
                        animateMouseClick({
                            target: domNode, flyIn: true, onFinished: () => {
                                window.setTimeout(() => {
                ...
                {
                    selector: "#inner-content-wrapper",
                    content: "That's it! Thank you for using FMU editor. If you have any feedback, please let us know :-)",
                    action: () => {
                        dispatch(setView(View.Editor));
                    },
                },
    ...
    return (
        ...
        <Dialog open={open} onClose={handleCancel}>
            ...
            <DialogContent>
                This seems to be your first time using FMU editor. If you like, you can take a tour of the application.
            </DialogContent>
            <DialogActions>
            ...
            <Tour disableFocusLock disableInteraction={uncommitted} key={key} goToStep={0} steps={makeTourSteps()} isOpen={tourOpen} onRequestClose={handleCancel} />
            </>
    );
};